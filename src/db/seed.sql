...
INSERT INTO menu_categories (id, name, display_order, image_url) VALUES
  (1, 'Live on Tap', 1, '/assets/beer.webp'),
...
INSERT INTO menu_items (category_id, name, description, price, abv, image_url, day_of_week, is_available, is_active, is_local, is_gluten_free, display_order, servings_remaining) VALUES
  ...
  (2, 'Chicken Salad Sandwich', 'Tuesday special · served with fresh chips', 8.99, NULL, '/assets/food-chicken-salad-sandwich.webp', 2, 1, 1, 0, 0, 1, NULL),
  (2, 'Wrap Wednesday', 'Any wrap, served with fresh chips', 8.99, NULL, '/assets/food-wrap.webp', 3, 1, 1, 0, 0, 2, NULL),
  (2, 'Hamburger Special', 'Thursday special · served with fresh chips', 8.99, NULL, '/assets/food-burger.webp', 4, 1, 1, 0, 0, 3, NULL),
  (2, 'Pulled Pork Nachos', 'Friday special', 9.99, NULL, '/assets/food-pulled-pork-nachos.webp', 5, 1, 1, 1, 0, 4, NULL);
